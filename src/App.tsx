...
function Downloadlayer (props: { form: React.ReactNode; space: React.ReactNode; numbers: React.ReactNode; date: React.ReactNode; name: React.ReactNode; })
{
  return(
    <div>
    ...
    <div className="download-layer-right">
        <div><p id="download-margin">{props.form}</p></div>
        <div><p id="download-margin">{props.space}</p></div>
        <div><p id="download-margin">{props.numbers}</p></div>
        <div><p id="download-margin">{props.date}</p></div>
        <div><p id="download-margin">{props.name}</p></div>
      </div>
    </div>
    <hr/>
    </div>
    ...
    return(
        ...
        <div className='title'>
          <div className='title-left'>
            <div><img className='title-picture' src={require('./photos/武大校标.jpg')} /></div>
            <div><p id='big-font'>李兵实验室</p></div>
          </div>
          <div className='title-right'>
            <div className='nav-flex'><Link id='nav-a-set' to='/'> 首页</Link></div>
            <div className='nav-flex'><Link id='nav-a-set' to='/leaderteam'>导师团队</Link></div>
            <div className='nav-flex'><Link id='nav-a-set' to='/researchtarget'>研究方向</Link></div>
            <div className='nav-flex'><Link id='nav-a-set' to='/articalpublished'>发表文章</Link></div>
            <div className='nav-flex'><Link id='nav-a-set' to='/teamnews'>组内新闻</Link></div>
            <div className='nav-flex'><Link id='nav-a-set'to='/studentshow'>学生风采</Link></div>
            <div className='nav-flex'><Link id='nav-a-set'to='/resoursedownload'>资源下载</Link></div>
            <div className='nav-flex'><Link id='nav-a-set'to='/english'>english</Link></div>
          </div>
        </div>
        ...
        <div id='news-flex'>
          <div className='newsOfresearchGroup'>
            <div className='news-discription'>
              <div>
                <div>
                  <img id='nobel-picture' src={require('./photos/homepage-nobel.jpg')} />
                </div>
    ...
    return(
      ...
      <div className='content-leaderteam'>
        <div className='content-leaderteam-left'>
         <div><img src={require('./photos/导师团队.jpg')}></img></div>
         <div id='flex-row'>
           <div><p id='paragraph-big'>李兵</p></div>
           <div>教授 博士生导师</div>
         </div>
         <div id='flex-row'>
           任职：计算机学院副院长
        ...
        <div id="flex-row"><div id="title-small-font">研究方向</div></div>
            <div id="flex-row"><div>
                ⼤数据安全,复杂系统建模,⾯向服务的软件⼯程,⼈⼯智能,软件⼯程,云<br/>
                计算与⼤数据处理</div></div>
            <div id="flex-row"><div id="title-small-font">学习⼯作经历</div></div>
            <div id="flex-row"><div>
                2018.01—现在，武汉⼤学，计算机学院，教授、博⼠⽣导师。<br/>
            
                2014.07—2017.12，武汉⼤学，国际软件学院，教授、博⼠⽣导师。<br/>
            
                2005.05—2014.06，武汉⼤学，计算机学院，教授、博⼠⽣导师。<br/>
            
                2003.05—2005.05，武汉⼤学，计算机科学与技术流动站，博⼠后。<br/>
            
                1990.09—2005.05，湖北⼤学，数学与计算机科学学院，副教授。</div></div>
            <div id="flex-row"><div id="title-small-font">重要学术奖项</div></div>
            <div id="flex-row"><div>
                2015年湖北省科技进步⼀等奖（⽀撑⼤型企业云管理的软件服务化关<br/>
                键技术、国际标准、平台及应⽤）；<br/>
            
                2014年中国计算机学会科技进步⼀等奖(云计算中软件服务化的关键<br/>
                技术、国际标准、平台及应⽤);<br/>
            
                2011年湖北省科技进步⼀等奖（⾯向服务的软件互操作性关键技术及<br/>
                其ISO标准化）；<br/>
            
                2010年湖北省标准创新贡献奖⼀等奖；</div></div>
            <div id="flex-row"><div id="title-small-font">发表论⽂</div></div>
            <div id="flex-row"><div>
                杨荣， 李兵. 流程⽚段⾃适应重⽤策略研究. 软件学报，2015, 26(4):778-789.（EI）<br/>
            
                熊伟， 李兵. 云计算环境下基于能耗感知的弹性资源管理机制. 四川⼤学学报 (⼯程科学<br/>
                版) .2015, 2[3]. （EI）<br/>
            
                汪⽂娟， 李兵， 何鹏. 开源软件社区开发者⾓⾊的演化分析. 复杂系统与复杂性科学.<br/>
                2015, 12(1). （EI） <br/>
               
                何鹏， 李兵， 程璨， 曾诚. 开源软件系统中社会-技术⽹络的协同演化分析. 复杂系统与<br/>
                复杂性科学. 2015, 12(2). （EI）<br/>
                </div></div>
        </div>
         </div>
         </div>
  ...
  render() {
    return (
      ...
      <div className="content-researchtarget">
        ...
        <div id="flex-row"><img src={require("./photos/人工智能.jpg")} style={{width:'300px'}}/></div>
        <div> <p id="title-small-font">主研方向</p></div>
        <div><p>持续学习、迁移学习、图像识别</p></div>
        </div>
      </div>
      </div>
  ...
  render() {
    return (
      ...
      <div className="download-flex">
        ...
        <div className="download-layer-right">
          <div><p id="download-margin">文件类型</p></div>
          <div><p id="download-margin">文件大小</p></div>
          <div><p id="download-margin">下载量</p></div>
          <div><p id="download-margin">上传日期</p></div>
          <div><p id="download-margin">上传者</p></div>
        </div>
      </div>
      <div><hr/></div>
    </div>
    <Downloadlayer form="pdf" space="50kb" numbers="100" date="2020-10-18" name="朱江源"/>
    <Downloadlayer form="pdf" space="50kb" numbers="100" date="2020-10-18" name="朱江源"/>
    <Downloadlayer form="pdf" space="50kb" numbers="100" date="2020-10-18" name="朱江源"/>
    <Downloadlayer form="pdf" space="50kb" numbers="100" date="2020-10-18" name="朱江源"/>
    <Downloadlayer form="pdf" space="50kb" numbers="100" date="2020-10-18" name="朱江源"/>
  ...
  render() {
    return (
     <div className="content-articalpublished">
       <div><h2>2019年</h2></div>
       <div  id='flex-row'>2. Fuyu Yuan, Juan Li, Supawadee Namuangruk,*, Nawee Kungwan, Jia Guo,* and Changchun Wang, Microporous, Self-<br/>
        Segregated, Graphenal Polymer Nanosheets Prepared by Dehydrogenative Condensation of Aza-PAHs Building Blocks in the<br/>
        Solid State, Chemistry of Materials 2017, 29, 3971-3979.</div>
    
     
       <div id='flex-row'><img src={require("./photos/发表文章.jpg")} style={{width:'200px'}}/></div>
     
      <p id='flex-row'>1. Yongjing Li, Jiaxun Wan, Zihao Zhang, Jia Guo, and Changchun Wang*, Targeted Soft Biodegradable Glycine/PEG/RGDModified<br/>
        Poly(methacrylic acid) Nanobubbles as Intelligent Theranostic Vehicles for Drug Delivery, ACS Applied Materials <br/>
        Interfaces, 2017, 9, 35604-35612.</p>
        <div id='flex-row'><img src={require("./photos/发表文章.jpg")} style={{width:'200px'}}/></div>
        </div>
...
class English extends Component {
    render() {
        return (
         <div>this page is not finished.</div>
        );
      }
}
